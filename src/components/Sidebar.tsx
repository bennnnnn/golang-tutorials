            ...
            return (
              <li key={tutorial.slug}>
                ...
                <div className="flex items-center">
                  <Link
                    href={href}
                    className={`flex flex-1 items-center gap-2.5 rounded-lg px-3 py-2 text-sm transition-all duration-150 ${
                      isOnThisPage
                  ...
                  {tutorial.subtopics.length > 0 && (
                    <button
                      ...
                      className="mr-1 rounded p-1 text-zinc-400 transition-colors hover:bg-zinc-200 hover:text-zinc-600 dark:text-zinc-500 dark:hover:bg-zinc-700 dark:hover:text-zinc-300"
